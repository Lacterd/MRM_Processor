...
class MRMProcessorUI(QWidget):
    ...
    def initUI(self):
        ...
        self.LineEdit_Int_min_Quantitative = QLineEdit('3000')
        self.LineEdit_Int_min_Qualitative = QLineEdit('1000')
        self.LineEdit_Point = QLineEdit('6')
        ...
        self.Combox_Smooth.addItems(['2','1','0'])
        self.Combox_Smooth.setCurrentText('1')
    ...
    def on_multiprocess_done(self, result_dict):
        ...
        for i in self.Data_params.keys():
            ...
            self.RT_fix[i] = self.Data_params[i]['TargetList'].loc[:, 'RT']
